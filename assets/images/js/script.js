...
let playerChoice = "";
let cpuChoice = "";
let cpuOptions = ["rock", "hand", "scissors", "lizard", "spock"];
let playerScore = 0;
let cpuScore = 0;
let winMessage = "";
...
function determineWinner() { 
    ...
    let win0 = "Draw!";
    let win1 = "Scissors cuts hand!";
    let win2 = "hand covers Rock!";
    ...
    let win7 = "Lizard eats hand!";
    let win8 = "hand disproves Spock!";
    ...
    // Scissors + Paper //
    else if (playerChoice === "scissors" && cpuChoice === "hand") {
        winMessage = win1;
        incPlayerScore();
    }
    else if (playerChoice === "hand" && cpuChoice === "scissors") {
        winMessage = win1;
        incCpuScore();
    }
    // Paper + Rock //
    else if (playerChoice === "hand" && cpuChoice === "rock") {
        winMessage = win2;
        incPlayerScore();
    }
    else if (playerChoice === "rock" && cpuChoice === "hand") {
        winMessage = win2;
        incCpuScore();
    }
    // Rock + Lizard //
    ...
    // Lizard + Paper //
    else if (playerChoice === "lizard" && cpuChoice === "hand") {
        winMessage = win7;
        incPlayerScore();
    }
    else if (playerChoice === "hand" && cpuChoice === "lizard") {
        winMessage = win7;
        incCpuScore();
    }
    // Paper + Spock //
    else if (playerChoice === "hand" && cpuChoice === "spock") {
        winMessage = win8;
        incPlayerScore();
    }
    else if (playerChoice === "spock" && cpuChoice === "hand") {
        winMessage = win8;
        incCpuScore();
    }
    // Spock + Rock //
